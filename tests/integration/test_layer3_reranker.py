...
async def test_layer3_reranker_integration():
    ...
    with patch("skills.legal_retriever.main.get_reranker") as mock_get_reranker:
        ...
        mock_reranker_instance.rerank.return_value = [{"content": "Mock Doc", "source": "test", "score": 0.9}]
        ...
        with patch("skills.legal_retriever.main.QdrantClient"), \
    ...
    with patch("skills.legal_retriever.main.QdrantVectorStore") as mock_vectorstore_cls, \
         patch("skills.legal_retriever.main.HuggingFaceEmbeddings"):
        ...
        with patch("skills.legal_retriever.main.get_reranker") as mock_get_reranker:
            ...
            mock_reranker.rerank.return_value = [{"content": "Doc 1", "source": "url1", "score": 0.9}]
            ...
            assert called_profile == profile, f"Reranker called with wrong profile: {called_profile}"
