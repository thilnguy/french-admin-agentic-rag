...
async def test_stream_filtering():
    ...
    # Create Orchestrator
    with patch("src.agents.orchestrator.memory_manager", mock_memory), \
        ...
        mock_intent.classify = AsyncMock(return_value=Intent.COMPLEX_PROCEDURE) # To trigger Slow Lane
