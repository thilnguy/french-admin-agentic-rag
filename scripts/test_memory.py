...
async def test_memory():
    ...
    res1 = await orchestrator.handle_query("My name is Anh and I come from Hanoi. How do I apply for a French passport?", user_lang="en", session_id=session_id)
    ...
    res2 = await orchestrator.handle_query("Do you remember my name? Answer in Vietnamese.", user_lang="vi", session_id=session_id)
    ...
    res3 = await orchestrator.handle_query("Do you remember my city? Answer in Vietnamese.", user_lang="vi", session_id=session_id)
    print(f"Response (Vietnamese):\n{res3}")
