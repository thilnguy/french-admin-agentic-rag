...
def ingest_agent_public_dataset(dataset_id: str, collection_name: str, embedding_col: str):
    """
    ...
    sample = next(iter(ds))
    vector_size = len(sample[embedding_col])
    ...
    for i, row in enumerate(ds):
        ids.append(i)
        vectors.append(row[embedding_col])
